...
import { Plus, FileText, Trash2, TrendingUp, AlertTriangle, CheckCircle } from "lucide-react-native";
...
const styles = StyleSheet.create({
  ...
  contentWrapper: { flex: 1, backgroundColor: "#F8F9FB", position: "relative" },
  ...
  title: { fontSize: 28, color: colors.primaryBlack, fontWeight: "700" },
  fabButton: {
    position: "absolute",
    bottom: 24,
    right: 24,
  ...
  statValue: { fontSize: 15, fontWeight: "700", color: colors.primaryBlack },
  ...
  filterCountActive: { backgroundColor: "rgba(255,255,255,0.30)" },
  filterCountText: { fontSize: 10, fontWeight: "600", color: "#6B7280" },
  ...
  cardMeta: { fontSize: 12, color: "#6B7280", fontWeight: "400" },
  cardDate: { fontSize: 12, color: "#94A3B8", fontWeight: "400" },
  ...
  progressText: { fontSize: 11, fontWeight: "600", color: "#475569", width: 34, textAlign: "right" },
  gapText: { fontSize: 11, fontWeight: "500", color: "#DC2626" },
