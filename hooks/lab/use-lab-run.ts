...
import { startLabRun, fetchLabRun, logLabAction, completeLabRun } from "@/api/lab";
import { LabRunType, LogLabActionRequestType, LogLabActionResponseType } from "@/types/lab";
